...
\begin{figure}[H]
    \centering
    \includegraphics[width = 7cm, height = 7cm]{chapters/chapter_3/figures/partisanship/plot_partisan_by_year.pdf}
    \includegraphics[width = 7cm, height = 7cm]{chapters/chapter_3/figures/partisanship/plot_partisan_by_region.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 7cm, height = 8cm]{chapters/chapter_3/figures/partisanship/plot_edu_mean.pdf}
    \includegraphics[width = 7cm, height = 8cm]{chapters/chapter_3/figures/partisanship/plot_age_mean.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 7cm, height = 7cm]{chapters/chapter_3/figures/partisanship/plot_partisanship_by_cbo_group.pdf}
    \includegraphics[width = 7cm, height = 7cm]{chapters/chapter_3/figures/partisanship/plot_partisanship_by_contract_type.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width = 7cm, height = 7cm]{chapters/chapter_3/figures/turnover/plot_wage.pdf}
    \includegraphics[width = 7cm, height = 7cm]{chapters/chapter_3/figures/turnover/plot_work_experience.pdf}
